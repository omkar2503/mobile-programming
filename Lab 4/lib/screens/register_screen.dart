                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['contact'] = val,
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['rollNo'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Graduation College'),
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['gradCollege'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Graduation Year of Passing'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['gradYear'] = val,
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['hscCollege'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'HSC Year of Passing'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['hscYear'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'HSC Total'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['hscTotal'] = int.parse(val!),
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'HSC Out Of'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['hscOutOf'] = int.parse(val!),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          ...
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['sscCollege'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'SSC Year of Passing'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['sscYear'] = val,
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'SSC Total'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['sscTotal'] = int.parse(val!),
                        ),
                        TextFormField(
                          decoration: InputDecoration(labelText: 'SSC Out Of'),
                          keyboardType: TextInputType.number,
                          validator: (val) => val!.isEmpty ? 'Required' : null,
                          onSaved: (val) => _formData['sscOutOf'] = int.parse(val!),
                        ),
                      ],
                    ),
                  ),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        TextFormField(
                          decoration: InputDecoration(labelText: 'Additional Courses'),
                          onSaved: (val) => _formData['courses'] = val,
                        ),
                        ElevatedButton(
                        ...
                        if (_resumeFileName != null)
                          Text('Selected file: $_resumeFileName', style: TextStyle(color: Colors.green)),
                        ElevatedButton(
                          onPressed: () {
